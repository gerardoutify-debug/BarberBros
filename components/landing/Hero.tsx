    ...
    <section className='hero-section relative h-[100svh] w-full overflow-hidden flex items-center justify-center'>
      ...
      <div className='container-x relative z-10 text-center'>
        ...
        <div className='flex flex-col sm:flex-row items-center justify-center gap-5 hero-fade'>
          <a
            href='/book'
            className='bg-[#c9a96e] text-[#0a0c0f] px-10 py-5 text-xs uppercase tracking-widest font-bold hover:bg-[#d4b87a] hover:scale-105 transition-all duration-300 shadow-lg shadow-[#c9a96e]/25'
          >
            Reservar Ahora
          </a>
          <a
            href='#servicios'
            className='border border-[#f0ede8]/30 text-[#f0ede8] px-10 py-5 text-xs uppercase tracking-widest font-medium hover:border-[#c9a96e] hover:text-[#c9a96e] transition-all duration-300'
          >
            Ver Servicios
          </a>
        </div>
